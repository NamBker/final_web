<?php
class Controller_User_Comments extends Controller_User
{
	...
	public function action_index()
	{
		...
		$this->template->content = View::forge('user/comments/index', $data);
	}
	...
	public function action_view($id = null)
	{
		...
		$this->template->content = View::forge('user/comments/view', $data);
	...
	public function action_create()
	{
		if (Input::method() == 'POST')
		{
			...
			if ($val->run())
			{
				...
				if ($comment and $comment->save())
				{
					...
					Response::redirect('user/comments');
				}
				else
				{
		...
		$this->template->title = "Comments";
		$this->template->content = View::forge('user/comments/create');
	...
	public function action_edit($id = null)
	{
		...
		$this->template->title = "Comments";
		$this->template->content = View::forge('user/comments/edit');
