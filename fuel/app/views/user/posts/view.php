...
<p>
	<strong>Tags:</strong>
	<a href="/user/tags/search/?tags=<?php echo $post->slug ?>" title=""><?php echo $post->slug; ?></a>&nbsp;&nbsp;<i class="glyphicon glyphicon-tag"></i></p>
...
<div class="row">
	...
	<div class="col-md-6">	
		<div class="row">
			<div class="col-md-2"><img src="/assets/img/<?php echo $current_user->img ?>" alt=""  style="font-size:20px; color:#4786B6; padding-top:10px; width:50px;padding-top: 5px;padding-bottom:5px"></div>
			<div class="col-md-10"><p>You write a comment</p>
		</div>
		</div>
		<?php echo Form::open('user/posts/view/'.$post->id) ?>	
	    <br>   
	    <br>   
	    <div class="input">
	    	<div class="row">
...
<?php echo Html::anchor('user/posts/edit/'.$post->id, 'Edit'); ?> |
<?php echo Html::anchor('user/posts', 'Back'); ?>
